...
def main():
    ...
    modelos_final = entrenar_modelo_final_pesos(X_train, y_train, pesos_train, mejores_params)  ## Cambio realizado para EXp WhatIf 2 (sin ensamble de seeds)

    # Generar predicciones finales
    logger.info("Generar predicciones finales")
    resultados = generar_predicciones_finales(modelos_final, X_predict, clientes_predict, 0.08093)  ## Cambio para Exp2
