...
def main():
    ...
    # Evaluar en test
    logger.info("=== Evaluación con mismo undersampling ===")
    _ = evaluar_en_test_pesos(df_fe, mejores_params, n_semillas=N_SEMILLERO, semilla_base=SEMILLA[0], undersampling=conf.parametros_lgb.undersampling)

    logger.info("=== Evaluación con undersampling final ===")
    _ = evaluar_en_test_pesos(df_fe, mejores_params, n_semillas=N_SEMILLERO, semilla_base=SEMILLA[0], undersampling=conf.parametros_lgb.undersampling_final)
